...
public class SecureKeysManagerEditor : Editor
{
    ...
    public virtual void LoadSkin()
    {
		...
		if (EditorGUIUtility.isProSkin)
		{
			editorSkin = ((GUISkin)AssetDatabase.LoadAssetAtPath(path + "skind.guiskin", typeof(GUISkin))) as GUISkin;
		}
		else
		{
			editorSkin = ((GUISkin)AssetDatabase.LoadAssetAtPath(path + "skin.guiskin", typeof(GUISkin))) as GUISkin;
		}
		#endregion
    }
