...
namespace LeTai.Asset.TranslucentImage
{
    ...
    public class TranslucentImageSource : MonoBehaviour
    {
        ...
        [Tooltip(
            ...
            " Lower if you need more performance")] public float maxUpdateRate = float.PositiveInfinity;

        /// <summary>
        /// Render the blurred result to the render target
        /// </summary>
        [Tooltip("Preview the effect on entire screen")] public bool preview;
        ...
        public float Strength
        {
            get
            {
                return strength = Size * Mathf.Pow(2, Iteration + Downsample);
            }
            set
            {
        ...
        float ScreenSize
        {
            ...
            get
            {
                return Mathf.Min(Cam.pixelWidth, Cam.pixelHeight) / 1080f;
            }
        }
        ...
        float MinUpdateCycle
        {
            get
            {
                return (maxUpdateRate > 0) ? (1f / maxUpdateRate) : float.PositiveInfinity;
            }
        }
