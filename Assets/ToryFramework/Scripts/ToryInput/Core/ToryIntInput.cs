...
namespace ToryFramework.Input
{
	...
	/// </summary>
	public class ToryIntInput : ToryInput<int>
	{
		#region CONSTRUCTOR

		protected ToryIntInput() { }
		...
		public override int RawValue 							{ get; protected set; }
		...
		public override int ProcessedValue 						{ get; protected set; }
		...
		public override ToryMultiInput<int>[] MultiInputs 		{ get; protected set; }
		...
		protected override void Init()
		{
			...
			// Filters
			ensemble = new Queue<int>();
			oef = new OneEuroFilter(OEFFrequency.Value);
			prevProcessedValue = ProcessedValue = RawValue = 0;
		...
		protected override int ApplyFilter(int value, float timeStamp = -1f)
		{
			...
			Queue<int>.Enumerator e = ensemble.GetEnumerator();
			while (e.MoveNext())
			{
				eaResult += e.Current;
			}
		...
		public override bool AddMultiInput()
		{
			...
			ToryMultiInput<int> mi = new ToryIntMultiInput();
		...
		public override bool AddMultiInput(int id)
		{
			...
			// Add a new multi-input.
			ToryMultiInput<int> mi = new ToryIntMultiInput(id);
			multiInputList.Add(mi);
			MultiInputs = multiInputList.ToArray();
			mi.ValueReceived += TriggerMultiInputValueReceivedEvent;
			mi.Interacted += TriggerMultiInputInteractedEvent;
