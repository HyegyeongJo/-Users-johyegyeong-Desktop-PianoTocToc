...
namespace ToryFramework.Input
{
	...
	/// </summary>
	public class ToryVector3Input : ToryInput<Vector3>
	{
		#region CONSTRUCTOR

		protected ToryVector3Input() { }
		...
		public override ToryMultiInput<Vector3>[] MultiInputs 	{ get; protected set; }
		...
		public override bool AddMultiInput()
		{
			...
			ToryMultiInput<Vector3> mi = new ToryVector3MultiInput();
		...
		public override bool AddMultiInput(int id)
		{
			...
			// Add a new multi-input.
			ToryMultiInput<Vector3> mi = new ToryVector3MultiInput(id);
			multiInputList.Add(mi);
			MultiInputs = multiInputList.ToArray();
			mi.ValueReceived += TriggerMultiInputValueReceivedEvent;
			mi.Interacted += TriggerMultiInputInteractedEvent;
		...
		public override bool RemoveMultiInput(ToryMultiInput<Vector3> input)
		{
			// Check the length.
		...
		public override bool RemoveMultiInput(int id)
		{
			...
			ToryMultiInput<Vector3> mi = multiInputList.Find( (obj) => { return obj.Id.Equals(id); } );
		...
		public override bool RemoveMultiInputAt(int i)
		{
			...
			ToryMultiInput<Vector3> mi = multiInputList.Find( (obj) => { return obj.Id.Equals(MultiInputs[i].Id); } );
			if (mi != null && multiInputList.Remove(mi))
			{
				MultiInputs = multiInputList.ToArray();
				mi.ValueReceived -= TriggerMultiInputValueReceivedEvent;
