...
+ (int)PrepareAudio:(int) alBufferIndex IntoSourceCycle:(int) sourceCycle
{
    ...
    NativeAudioBufferIdPair nabip = nabips[alBufferIndex];
...
+(void) GetAudioDevices: (int*) enumArray
{
...
extern "C" {
    ...
    void _GetAudioDevices(int* enumArray)
    {
        return [NativeAudio GetAudioDevices:enumArray];
    }
