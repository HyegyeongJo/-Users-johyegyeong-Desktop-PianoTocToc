...
namespace E7.Native
{
    ...
    {
        /// <summary>
        /// You can modify volume, pan, etc. on BEFORE play with this struct. On some platforms like iOS, adjusting them after the play with <see cref="NativeAudioController"> is already too late because you will already hear the audio. (Even in consecutive lines of code)
        /// 
        /// It has to be a struct since this will be sent to the native side, interop to a matching code in other language. If you want the correct default value before modifying something further, start from <see cref="PlayOptions.defaultOptions">
        /// </summary>
        ...
        public struct PlayOptions
        {
            ...
            /// <summary>
			/// - If -1 (<see cref="PlayOptions.defaultOptions">) The track/player at native side will be round robin selected for you.
			...
			/// This is zero indexed. If you specify you want 3 AudioTracks at <see cref="NativeAudio.Initialize(InitializationOptions)"> you can use 0, 1, and 2.
			...
			/// the number of AudioTrack specify when <see cref="NativeAudio.Initialize(InitializationOptions)"> You also know that some of the track requested might be fast. Native Audio request AudioTrack
			...
			/// - You can use -1 to auto-select AudioTrack first, then force the next sound use that same track by asking <see cref="NativeAudioController.InstanceIndex">
            ...
            /// To protect the looping sound, you likely have to plan your track number usage manually with <see cref="audioPlayerIndex">.
            /// </summary>
